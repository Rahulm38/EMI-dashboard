...
const RepeatUserAnalytics = ({ metrics }) => {
  ...
  const barChartData = {
    labels: ['1st Plan', '2nd Plan (Repeat)'],
    datasets: [
      {
  ...
  const portfolioData = [
    { name: 'Single-Plan Users', volume: stats.singleVolume, fill: 'var(--text-tertiary)' },
  ...
  return (
    <>
      <div className="col-span-12 glass-card animate-fade-in delay-2 flex-col">
        ...
        <p className="card-subtitle">All identifiers in the demo dataset are synthetic and generated for analytics examples.</p>
        ...
        <div className="metric-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', marginTop: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <div className="metric-item">
            ...
            <span className="metric-value" style={{ color: 'var(--amber)' }}>{stats.avgDaysBetweenPlans} days</span>
            <span className="metric-sub">before next plan</span>
          </div>
          ...
          <div className="metric-item">
            ...
            <span className="metric-sub">on 2nd plan</span>
          </div>
        </div>
      ...
      <div className="col-span-6 glass-card animate-fade-in delay-3 flex-col">
        <h3 className="card-title" style={{ fontSize: '1rem', marginBottom: '1rem', textAlign: 'center' }}>Behavioral Shift (1st vs 2nd Plan)</h3>
              ...
              <table className="top-bookings-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ textAlign: 'right' }}>PLANS</th>
                ...
                <tbody>
                  {stats.repeatUsersList && stats.repeatUsersList.map((user, idx) => (
                    <tr key={idx}>
                      ...
                      <td style={{ textAlign: 'right', fontWeight: '600', color: 'var(--text-primary)' }}>{user.planCount}</td>
